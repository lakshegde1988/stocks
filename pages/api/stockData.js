        ...
        <div className="flex items-center space-x-2">
          ...
          <div className="w-48 sm:w-64 relative" ref={searchRef}>
            ...
            {showDropdown && searchTerm && (
              <div className="absolute w-48 mt-1 py-1 bg-background border border-slate-200/5 rounded-lg shadow-lg max-h-60 overflow-y-auto z-50 right-0">
